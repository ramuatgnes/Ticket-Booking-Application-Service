...
public class ErrorMessageConstant {
    public static final String SOMETHING_WENT_WRONG = "Something Went Wrong Plz Try Again";
    public static final String USER_EMAIL_ALRADY_EXIST = "User email Alrady exist";
